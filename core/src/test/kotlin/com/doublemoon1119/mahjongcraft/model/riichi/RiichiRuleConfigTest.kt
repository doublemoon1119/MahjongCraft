...
class RiichiRuleConfigTest {
    ...
    /**
     * 測試日本麻將特有屬性（如赤寶牌數量）與積分配置的存取與正確性。
     */
    @Test
    fun `test riichi specific configuration`() {
        ...
        // 驗證積分配置屬性
        assertEquals(25000, config.scoreConfig.initialScore, "Default initial score should be 25000")
        assertEquals(0, config.scoreConfig.bustThreshold, "Default bust threshold should be 0")
    }
}