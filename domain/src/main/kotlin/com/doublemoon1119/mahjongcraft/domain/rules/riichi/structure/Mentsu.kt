 ...
 * 與 [com.doublemoon1119.mahjongcraft.domain.base.Meld] 不同：
 * - [com.doublemoon1119.mahjongcraft.domain.base.Meld] 用於表示遊戲狀態中的副露（已公開的牌組），
 *   包含 [com.doublemoon1119.mahjongcraft.domain.base.MeldType]、來源方向等遊戲狀態資訊。
