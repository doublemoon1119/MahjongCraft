 ...
 *
 * 實作此介面的動態狀態類別（如 [com.doublemoon1119.mahjongcraft.domain.rules.riichi.RiichiDynamicState]）
...
interface TileWallRevealable {
     ...
     * @return 包含所有應公開 [com.doublemoon1119.mahjongcraft.domain.base.IdentifiedTile] 之 ID 的 [Set]
     */
