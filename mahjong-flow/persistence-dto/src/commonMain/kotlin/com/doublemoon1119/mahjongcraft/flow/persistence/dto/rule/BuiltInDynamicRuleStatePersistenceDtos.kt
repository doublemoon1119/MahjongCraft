...
fun buildDynamicRuleStatePersistenceRegistry(): PersistenceDtoRegistry<DynamicRuleState> = PersistenceDtoRegistry<DynamicRuleState>()
    .apply {
        register(
            ...
            toDto = { RiichiDynamicStatePersistenceDto(it.riichiStickCount, it.completedSupplementalDrawCount) },
            toDomain = { RiichiDynamicState(it.riichiStickCount, it.completedSupplementalDrawCount) },
        )
    }
