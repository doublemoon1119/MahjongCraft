 ...
 *   由 [MahjongRuleModule.declareExhaustiveDraw][com.doublemoon1119.mahjongcraft.logic.module.MahjongRuleModule.declareExhaustiveDraw]
 *   依對局人數換算為「基數 * (人數 - 1)」（四人對局為 3000、三人對局為 2000），而非這裡直接設定
 *   固定總額——這樣不同玩家人數的對局才能共用同一個基數設定，不需要為每種人數各自設定總額。
 */
