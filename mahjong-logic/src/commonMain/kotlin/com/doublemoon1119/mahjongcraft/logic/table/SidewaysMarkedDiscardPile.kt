 ...
 *
 * 實作此介面的 [DiscardPile] 類別（如
 * [com.doublemoon1119.mahjongcraft.logic.rules.riichi.RiichiDiscardPile]）負責根據自身紀錄，計算並
...
interface SidewaysMarkedDiscardPile {
     ...
     * 獲取目前應該側身標示的那張牌唯一識別碼。
     *
     * @return 應側身呈現的 [com.doublemoon1119.mahjongcraft.logic.base.IdentifiedTile] 唯一識別碼；
     * 沒有任何一張需要側身時回傳 `null`。
     */
