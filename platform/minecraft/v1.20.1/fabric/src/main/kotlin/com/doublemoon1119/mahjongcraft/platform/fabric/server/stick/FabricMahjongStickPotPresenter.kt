...
class FabricMahjongStickPotPresenter(
    ...
    override fun present(presentation: MahjongStickPotPresentation): MahjongStickPotPresentationResult {
        ...
        val declaredSticks = presentation.declaredSeatIndices.map { seatIndex ->
