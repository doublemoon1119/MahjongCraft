 ...
 * [tileAssetRegistry] 轉交給 [Tile.toDisplayText] 解析 [referenceTile] 本身（例如第三方牌種）的顯示
 * 名稱與牌面 emoji。
 *
...
private fun tileActionText(
    ...
    displayNameRegistry: TileDisplayNameRegistry,
    tileAssetRegistry: MinecraftTileAssetRegistry,
): Text = Text.translatable(key, referenceTile?.toDisplayText(displayNameRegistry, tileAssetRegistry) ?: Text.literal("?"))
